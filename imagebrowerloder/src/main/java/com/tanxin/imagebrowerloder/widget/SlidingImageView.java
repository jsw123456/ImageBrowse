package com.tanxin.imagebrowerloder.widget;
...
import com.tanxin.imagebrowerloder.R;
...
public class  SlidingImageView extends PhotoView {
    public enum Status {
        STATE_NORMAL,
        STATE_IN,
        STATE_OUT,
    ...
    public void setOnTransformListener(SlidingImageView.onTransformListener onTransformListener) {
        this.onTransformListener = onTransformListener;
    }

    public static int getStatusBarHeight(Context context) {
        int statusBarHeight = context.getResources().getDimensionPixelSize(R.dimen.dimens_50px);
        try {
